...
%subject (numsess)
function pltBayes(normSP,normSH,normCO,Phases,XZ,numsess,sz)
     for n = 1:numsess %choose sessions to plot. 131 total sessions per subject in this cohort. ~40 of them are in pre-drinking period
        ...
        plot(normSH{1,XZ}{1,n},'displayname','shape strategy');
        plot(normCO{1,XZ}{1,n},'displayname','color strategy');
